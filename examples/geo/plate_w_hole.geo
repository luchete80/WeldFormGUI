...
// 24 elements around circumference -> 6 per quadrant
Transfinite Curve {11,12,13,14} = nCirc/4 + 1;

// 24 elements around outer boundary -> 6 per side
Transfinite Curve {1,2,3,4} = nOuter/4 + 1;

Transfinite Surface {101} = {3,4,12,11};
Transfinite Surface {102} = {4,1,13,12};
Transfinite Surface {103} = {1,2,14,13};
Transfinite Surface {104} = {2,3,11,14};
