...
using namespace std;
// template <typename T>
// void  EntityDialog::Draw(const char* title, bool* p_open, T *mat){
...
Material_ ShowCreateMaterialDialog(bool* p_open, EntityDialog *matdlg, bool *create){
  ...
  EntityDialog->Draw("Material", p_open);
...
template <typename T>
bool ShowEditEntityDialog(bool* p_open, EntityDialog *matdlg, T *mat){
  ImGui::SetNextWindowSize(ImVec2(500, 400), ImGuiCond_FirstUseEver);
