...
#include <array>
#include "graphics/ogldev_math_3d.h"

//INTERFERES WITH ASSIMP
//#include "Types.h" //real
typedef float Real;
    ...
    */
    ...
    public:
        ...
        */
        ...
        typedef std::array<Vector3f, 8> Corners;
        ...
        */
				//LUCIANO
				//COMMENTED UNTIL BEING NECESSARY
        ...
        */
        ...
        Real squaredDistance(const Vector3f& v) const
        {
        ...
        Real distance (const Vector3f& v) const
        {
